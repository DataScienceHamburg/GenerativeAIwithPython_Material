...
# synchronous run
# def main():
#     result = Runner.run_sync(dispatcher_agent, "I want to order a pizza")
#     print(result)

#     result = Runner.run_sync(dispatcher_agent, "I ordered a while ago, but I haven't received my pizza yet. What's the status?")
#     print(result)
...
# stream run
async def main():
    result = Runner.run_streamed(dispatcher_agent, "I want to order a pizza")
    print(result)

    result = Runner.run_streamed(dispatcher_agent, "I ordered a while ago, but I haven't received my pizza yet. What's the status?")
    print(result)
